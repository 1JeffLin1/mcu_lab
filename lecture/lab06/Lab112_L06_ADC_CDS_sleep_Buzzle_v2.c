...
//  In Holtek C, char, int(16), short(16) --> 8 bits, long(32) --> 16 bits
	...
	unsigned char 	adc0h, adc0l, adc2h, adc2l; //,adc1h, adc1l;	
...
//*** Modifiy the if-else statements to conform to the required conditions	***// 
		...
		_pc0=0;
		if (adc2h*256+adc2l > 2*(adc0h*256+adc0l))
			_t0on = 1;
		else if (adc2h*256+adc2l < adc0h*256+adc0l)
		{
...
//	check whether the light intensity is in the normal range	    
		if ((adc2h*256+adc2l <= 2*(adc0h*256+adc0l)) && (adc2h*256+adc2l >= adc0h*256+adc0l))
			_pc0 = 1;
		else 
			_pc0 = 0;		    
//			
